...
private {
    ...
    static if(  Derelict_OS_Windows )
        enum libNames = "csfml-system.dll,csfml-system-2.dll,csfml-system-2.2.dll";
    else static if(  Derelict_OS_Mac )
        enum libNames = "libcsfml-system.dylib,libcsfml-system.2.dylib,libcsfml-system.2.2.dylib";
    else static if(  Derelict_OS_Posix )
        enum libNames = "libcsfml-system.so,libcsfml-system.so.2,libcsfml-system.so.2.2";
    else
