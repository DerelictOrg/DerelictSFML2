...
private {
    ...
    static if( Derelict_OS_Windows )
        enum libNames = "csfml-network.dll,csfml-network-2.dll,csfml-network-2.2.dll";
    else static if( Derelict_OS_Mac )
        enum libNames = "libcsfml-network.dylib,libcsfml-network.2.dylib,libcsfml-network.2.2.dylib";
    else static if( Derelict_OS_Posix )
        enum libNames = "libcsfml-network.so,libcsfml-network.so.2,libcsfml-network.so.2.2";
    else
