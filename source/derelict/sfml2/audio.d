...
private {
    ...
    static if( Derelict_OS_Windows )
        enum libNames = "csfml-audio-2.2.dll,csfml-audio-2.dll";
    else static if( Derelict_OS_Mac )
        enum libNames = "libcsfml-audio.2.2.dylib,libcsfml-audio.2.dylib";
    else static if( Derelict_OS_Posix )
        enum libNames = "libcsfml-audio.so.2.2,libcsfml-audio.so.2";
    else
